...
const user1 = new User("HyeJi", "Yang");
console.log(user1); // User {firstName: 'HyeJi', lastName: 'Yang', fullName: 'HyeJi Yang'}

user1.firstName = "Neo";
console.log(user1); // User {firstName: 'Neo', lastName: 'Yang', fullName: 'HyeJi Yang'}
...
const user2 = new NewUser("Hyeji", "Yang");
console.log(user2.fullName); // Hyeji Yang 

user2.lastName = "kim";
console.log(user2.fullName);

/** set이라는 키워드를 통해서 만든 fullName이라는 메서드는
 * 해당하는 fullName에다가 이렇게 할당 연산자를 통해서 어떤 값을 지정하려고 할때 동작하는 메서드라는 점입니다.
 */
