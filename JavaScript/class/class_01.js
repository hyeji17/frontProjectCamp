...
/** 객체 데이터의 메서드를 일반함수로 만들면, 일반 함수에서의 this는 함수가 호출하는 곳에서 정의된다고 배웠습니다.
 * 즉, user가 this가 됩니다.
 */
 ...
 */
console.log(user.getFullName.call(user2)); // => 재활용하는 코드의 가독성도 떨어지고, 메서드를 빌려쓰는 구조에서 본래의 객체도 참조해야하고 여러 어려움이 존재
